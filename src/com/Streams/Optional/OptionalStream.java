...
public class OptionalStream {
    ...
    public static void main(String[] args) {
        ...
        if(obj1.isPresent())
        {
            ...
            System.out.println("No Person Found With the ID");
        }
...
//Empty Method => Checks for whether Object Contain a Null Value or not
//of() Method
//ofNullable()
...
class Person1 {
    ...
    public String toString() {
        return "Person1{" + "name='" + name + '\'' + ", age=" + age + ", country='" + country + '\'' + '}';
    }
